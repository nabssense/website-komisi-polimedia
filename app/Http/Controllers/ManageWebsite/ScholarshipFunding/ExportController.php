...
class ExportController extends Controller
{
    public function exportExcel()
    {
        ...
        foreach ($scholarshipFundings as $funding) {
            ...
            $sheet->setCellValue('I' . $row, $funding->statement_letter ? 'www.komisipolimedia.com/storage/' . $funding->statement_letter : '');
            $sheet->setCellValue('J' . $row, $funding->mbkm_program);
            $sheet->setCellValue('K' . $row, $funding->student_activity);
            $sheet->setCellValue('L' . $row, $funding->activity_certificate ? 'www.komisipolimedia.com/storage/' . $funding->activity_certificate : '');
            ...
            $sheet->setCellValue('Q' . $row, $funding->competition_certificate ? 'www.komisipolimedia.com/storage/' . $funding->competition_certificate : '');
            $row++;
        }
