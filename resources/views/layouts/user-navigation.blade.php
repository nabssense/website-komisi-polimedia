...
<div class="w-full h-full flex-col justify-center items-center hidden px-0 md:px-8 xl:px-16 py-12 md:py-32 lg:flex gap-8">
    <div class="w-full h-full max-w-1480 bg-netral-100 flex-col justify-center items-center flex gap-8">
        <div
            class="w-full h-fit relative bg-netral-100 rounded-2xl  grid-cols-12 shadow-card justify-start items-start overflow-clip hidden lg:grid">
            <div
        ...
        {{-- Mobile Akun --}}
        <div
            class="w-full h-full p-4 relative bg-netral-100 rounded-2xl lg:hidden flex flex-col shadow-card justify-start items-start overflow-clip gap-4">
            <button onclick="pageUserProfile()"
