        ...
        <div class="bg-netral-100 w-full h-screen relative">
            <div id="divFull" class="w-screen h-screen bg-netral-100 shadow justify-start items-start absolute z-50 inline-flex flex-col">
                ...
                {{-- Main Content --}} <div id="MainContent" class="w-full h-full self-stretch px-560 flex-col justify-center items-center gap-8 inline-flex">
                    <div id="MainContent2" class="w-full h-fit max-w-1480 grow shrink basis-0 py-12 flex-col justify-center items-center gap-4 flex">
                            ...
                            <div class="self-stretch h-fit  flex-col justify-start items-start gap-8 flex">
                                <div class="self-stretch h-fit pt-3 flex-col justify-start items-start gap-4 flex">
                                    ...
                                    <div class="justify-start items-start inline-flex">
                                        ...
                                        <div class="w-full justify-center items-center flex flex-row relative">
                                            <input type="password" name="nama-kabinet" placeholder="Masukkan kata sandi kamu" id="password"
                                            class="w-full pt-2 pb-3 bg-white focus:border-b-2 focus:outline-none focus:border-primary-base focus:font-semibold font-semibold focus:text-netral-800 text-netral-800 border-b border-neutral-900 justify-start items-center gap-2 inline-flex placeholder:text-netral-300 text-lg placeholder:font-normal font-THICCCBOI leading-7">
                                ...
                                <a href="/" class="self-stretch h-10 pt-3 flex-col justify-start items-start gap-2 flex">
                                    <div class="self-stretch justify-end items-center inline-flex">
                                        <div class="text-right text-zinc-500 text-lg font-normal font-['THICCCBOI'] leading-7">
                                            Lupa kata sandi?</div>
                                    </div>
                                </a>
                        ...
                        <div class="self-stretch px-8 justify-center items-center gap-12 inline-flex">
                            <div class="grow shrink basis-0 text-zinc-900 text-lg font-normal font-['THICCCBOI'] leading-7">Kamu
                                calon mahasiswa? dan belum punya akun?</div>
                            <a href="/daftar-akun"
                                class="text-right text-rose-900 text-lg font-semibold font-['THICCCBOI'] leading-7">Daftar Dulu
                            </a>
                        </div>
                    </div>
                </div>
                ...
                {{-- Button --}} <button id="buttonAsli"
                        ...
                        <div id="text-btn" class="text-center text-white text-5xl font-extrabold font-['THICCCBOI'] leading-10">Masuk</div>
                        {{-- Animation Teks 1 --}}
