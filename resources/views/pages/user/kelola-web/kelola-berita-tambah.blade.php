            ...
            <div
                ...
                <div class="w-full h-fit self-stretch flex-col justify-start items-start gap-4 inline-flex">
                    ...
                    <div class="self-stretch h-fit flex-col justify-start items-start flex">
                        <div class="justify-start items-start inline-flex">
                            <div class="text-stone-700 text-base font-normal font-THICCCBOI leading-normal">Judul Berita
                            </div>
                        </div>
                    ...
                    <div class="self-stretch h-fit flex-col justify-start items-start flex">
                        <div class="justify-start items-start inline-flex">
                            <div class="text-stone-700 text-base font-normal font-THICCCBOI leading-normal">Isi Berita
                            </div>
                        </div>
                    ...
                    <div class="self-stretch justify-start items-start gap-4 inline-flex">
                        <div class="w-full h-fit flex-col justify-start items-start inline-flex">
                            <div class="justify-start items-start inline-flex">
                                <div class="text-stone-700 text-base font-normal font-THICCCBOI leading-normal">Kategori Berita
                                </div>
                            </div>
                            <!-- Input Field -->
                    ...
                    <div class="self-stretch justify-start items-start gap-4 inline-flex flex-col">
                        <div  id="toggle-button" class="w-full h-fit flex-col justify-start items-center inline-flex relative">
                            <div class="w-full justify-start items-start inline-flex">
                                <div class="text-stone-700 text-base font-normal font-THICCCBOI leading-normal">Headline News</div>
                            </div>
                        ...
                        <div id="gambar-headline" class="w-full bg-netral-200 rounded-lg p-4 flex-col justify-start items-start gap-1 hidden">
                            <div class="justify-start items-start inline-flex">
                                <div class="text-stone-700 text-base font-normal font-THICCCBOI leading-normal">Gambar Headline
                                </div>
                            </div>
                            <div class="self-stretch justify-start items-start gap-1 flex flex-wrap">
                                <div class="self-stretch justify-start items-center flex">
                                    <div
                                        class="w-96 h-48  bg-white px-6 py-4 rounded-2xl border border-stone-300 flex-col justify-center items-center gap-2 flex relative">
                                        <input class="w-full h-full bg-red-300 z-10 opacity-0 absolute cursor-pointer rounded-2xl"
                                            type="file" name="" id="">
                                        <img class="w-full h-full bg-red-300 z-0 opacity-0 absolute cursor-pointer rounded-2xl"
                                            type="file" name="" id="">
