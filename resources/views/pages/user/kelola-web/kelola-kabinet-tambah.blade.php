...
@section('container')
    ...
    <section class="w-full h-screen step hidden p-8 bg-netral-100 shadow justify-start items-start gap-12 "
        ...
        {{-- Stepper --}}
        <div
            class="h-full bg-netral-200 rounded-2xl self-stretch px-8 py-4 flex-col justify-center items-center gap-2 inline-flex">
            <div class="flex-col justify-start items-center flex">
                <div class="w-8 h-8 p-2.5 bg-gray-200 rounded-full flex-col justify-center items-center gap-2.5 flex">
                    <div class="text-white text-2xl font-extrabold font-THICCCBOI leading-9">1</div>
                </div>
        ...
        <div
            ...
            {{-- 3 --}}
            <div class="h-fit w-full pt-4 border-t-2 border-netral-800 justify-start items-start gap-4 flex">
                <button onclick="previousStep()" class="btn-secondary w-fit">Sebelumnya
                </button>
                <button onclick="nextStep()" class="btn-primary w-full">Selanjutnya
                </button>
            </div>
    ...
    <section class="w-full h-screen step hidden p-8 bg-netral-100 shadow justify-start items-start gap-12 "
        ...
        <div
            ...
            <div
                class="w-full h-full overflow-scroll overflow-x-hidden scrollbar-hidden-vertikal touch-pan-y grow shrink basis-0justify-start items-start gap-8 flex flex-row flex-1">
                <div class="h-full grow shrink basis-6/12 self-stretch gap-4 flex-col justify-start items-start flex">
                    <div class="self-stretch text-netral-900 text-2xl font-semibold font-THICCCBOI leading-9">Pilih
                        Divisi</div>
                    <div id="list-btn-divisi"
                ...
                <div id="list-form-tim"
                    class="w-full h-full bg-white flex-col justify-start items-start gap-12 inline-flex">
                </div>
            </div>
    ...
    {{-- STEP 4 --}}
    <section class="w-screen h-screen step hidden p-8 bg-netral-100 shadow justify-start items-start gap-12"
        id="step4">
        {{-- Stepper --}}
        <div
            class="h-full bg-netral-200 rounded-2xl self-stretch px-8 py-4 flex-col justify-center items-center gap-2 inline-flex">
        ...
        <div
            ...
            <div
                ...
                <div id="list-form-anggota"
                    class="grow basis-6/12 self-stretch bg-white flex-col justify-start items-start gap-8 inline-flex">
                </div>
            ...
            <div class="h-fit w-full pt-4 border-t-2 border-netral-800 justify-start items-start gap-4 flex">
                ...
                <button onclick="  " class="btn-primary w-full">Simpan Baru
            </div>
            </button>
        </div>
        </div>
    ...
    <script>
        ...
        function createForm(inputId) {
            ...
            form.classList.add('w-full', 'h-full', 'hidden', 'rounded-md', 'flex-col', 'justify-start', 'items-start',
                'gap-12', 'inline-flex');
            form.innerHTML = `
        <div class="self-stretch h-fit justify-start items-center gap-4 inline-flex">
                <div
        ...
        function createForm2(addDivinputId) {
            ...
            form2.classList.add('form-jabatan', 'hidden', 'w-full', 'h-full', 'grow', 'shrink', 'basis-3/12', 'bg-white',
        ...
        function createBtnJabatanAnggotaAndFormAnggota(addDivinputId) {
            ...
            buttonJabatan.classList.add('jabatan-btn', 'self-stretch', 'w-full', 'h-fit', 'flex-col', 'bg-netral-100',
                'rounded-xl', 'border', 'border-netral-200',
        ...
        function deleteButton(buttonJabatan, selectformAnggota, datainputId) {
            if (buttonJabatan && buttonJabatan.parentNode) {
                ...
                if (activeButtonJabatanId) {
                    const activeButtonJabatan = document.querySelector(
                        `.jabatan-btn[data-input-field-id="${activeButtonJabatanId}"]`);
        ...
        function createBtnJabatanAndFormAnggota2(addDivinputId) {
            ...
            buttonJabatanWakil.classList.add('jabatan-btn', 'self-stretch', 'w-full', 'h-fit', 'flex-col', 'bg-netral-100',
                'rounded-xl', 'border', 'border-netral-200',
                'justify-start', 'items-start', 'gap-1', 'cursor-pointer');
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function createButtonAndForm(text) {
                ...
                buttonDivisiText1.classList.add('divisi-btn', 'hidden', 'self-stretch', 'w-full', 'h-fit',
                    'flex-col', 'bg-netral-100', 'rounded-xl', 'border', 'border-netral-200',
                    'justify-start', 'items-start', 'gap-1', 'cursor-pointer');
                ...
                buttonDivisiText2.classList.add('divisi-btn', 'hidden', 'self-stretch', 'w-full', 'h-fit',
                    'flex-col', 'bg-netral-100', 'rounded-xl', 'border', 'border-netral-200',
                    'justify-start', 'items-start', 'gap-1', 'cursor-pointer');
                ...
                if (activeButtonId === inputId) {
                    ...
                    if (activeButtonId) {
                        ...
                        const activeButton = document.querySelector(
                            `#button-divisi-text-1[data-input-field-id="${activeButtonId}"]`);
                        activeButton.classList.remove('active', 'border-primary-base', 'bg-primary-100');
                        activeButton.classList.add('border-netral-200', 'bg-netral-100');
        ...
        function toggleFormAndButtonVisibility2(inputId, inputIdJabatanAnggota) {
            ...
            if (form2 && buttonDivisi && formAnggota && buttonJabatan) {
                ...
                if (activeButtonId2 !== activeButtonJabatanId !== inputId) {
                    ...
                    if (activeButtonId2) {
                        const activeButton = document.querySelector(
                            `#button-divisi-text-2[data-input-field-id="${activeButtonId2}"]`);
                        activeButton.classList.remove('active', 'border-primary-base', 'bg-primary-100');
                        activeButton.classList.add('border-netral-200', 'bg-netral-100');
        ...
        document.getElementById('addTextFieldBtn-divisi').addEventListener('click', function() {
            ...
            function removeItem(containerToRemove) {
                ...
                const associatedDivisiBtn1 = document.querySelector(
                    `#button-divisi-text-1[data-input-field-id="${addDivinputId}"]`);

                if (associatedDivisiBtn1) {
                    // Periksa apakah tombol yang dihapus sedang aktif
                    const isButtonActive = associatedDivisiBtn1.classList.contains('active', 'border-primary-base',
                        'bg-primary-100');
                ...
                const associatedDivisiBtn2 = document.querySelector(
                    `#button-divisi-text-2[data-input-field-id="${addDivinputId}"]`);
                if (associatedDivisiBtn2) {
                    // Periksa apakah tombol yang dihapus sedang aktif
                    const isButtonActive = associatedDivisiBtn2.classList.contains('active', 'border-primary-base',
                        'bg-primary-100');
            ...
            buttonDivisiText1.id = 'button-divisi-text-1';
            buttonDivisiText2.id = 'button-divisi-text-2';
            buttonDivisiText1.classList.add('divisi-btn', 'hidden', 'self-stretch', 'w-full', 'h-fit', 'flex-col',
                'bg-netral-100', 'rounded-xl', 'border', 'border-netral-200',
                'justify-start', 'items-start', 'gap-1', 'cursor-pointer');
            buttonDivisiText2.classList.add('divisi-btn', 'hidden', 'self-stretch', 'w-full', 'h-fit', 'flex-col',
                'bg-netral-100', 'rounded-xl', 'border', 'border-netral-200',
                'justify-start', 'items-start', 'gap-1', 'cursor-pointer');
            // Dalem Button 
            const divInsideButton1 = document.createElement('div');
