...
@section('container')
    {{-- STEP 1 --}}<div
        ...
        {{-- Main Content --}}
        <form method="POST" action="{{ route('forum-diskusi.store') }}" enctype="multipart/form-data"
                        ...
                        <div class="w-fit self-stretch justify-start items-center flex">
                            <div
                                ...
                                <img id="image-preview"
                                    class="w-full h-full object-cover absolute top-0 bg-white rounded-2xl hidden">
