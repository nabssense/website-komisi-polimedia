...
@section('container')
    <div class="w-full h-fit px-4 md:px-8 xl:px-16 py-8 bg-soft-base flex-col justify-center items-center inline-flex ">
        <div class="w-full max-w-1480 h-fit bg-soft-base flex-col justify-center items-center gap-8 inline-flex relative">
            <div class="self-stretch justify-start items-center gap-4 inline-flex">
                <div class="grow shrink basis-0 text-zinc-900 text-5xl font-extrabold font-THICCCBOI leading-10">Forum
                    Diskusi
                </div>
                <button onclick="pageForumDiskusiAjukanPertanyaan()"
                    class="px-8 py-3 bg-primary-base rounded-full justify-center items-center gap-6 flex">
            ...
            <div class="w-full max-w-1480 h-fit flex-col justify-start items-center gap-4 flex">
                <div class="self-stretch justify-center items-start gap-4 inline-flex ">
                    <div class="w-full h-fit bg-white rounded-full border justify-start items-center flex relative">
            ...
            {{-- Main Content --}}
            <div class="w-full h-fit self-stretch justify-center items-start gap-8 flex flex-col lg:flex-row ">
                {{-- Left Content --}}
                <section
                    class=" w-full h-fit self-stretch rounded-3xl flex-col justify-start items-start gap-4 flex">
                    <div
                        class="self-stretch px-6 py-4 bg-netral-100 rounded-lg justify-start items-center gap-4 inline-flex">
                        <div class="grow shrink basis-0 text-neutral-900 text-3xl font-semibold font-THICCCBOI leading-10">
                            Pertanyaan</div>
                    </div>
                            ...
                            <div class="self-stretch h-fit flex-col justify-start items-start gap-8 flex">
                                <div class="self-stretch h-fit flex-col justify-start items-start gap-6 flex">
                                    ...
                                    <div class="self-stretch h-16 px-6 flex-col justify-center items-start gap-2 flex">
                                        <div
                                            class="self-stretch text-zinc-900 text-lg font-normal font-THICCCBOI leading-7">
                        ...
                        <div
                            ...
                            <div class="self-stretch h-fit px-6 flex-col justify-start items-start gap-8 flex">
                                <div class="self-stretch h-fit flex-col justify-center items-start gap-6 flex">
                                    ...
                                    <div class="self-stretch h-fit flex-col justify-start items-start gap-4 flex">
                                        <div
                                            class="self-stretch text-neutral-900 text-2xl font-normal font-THICCCBOI leading-H4">
                                            Bagaimana tahapan kipk bisa cair ke rekening tiap mahasiswa? dan apakah kita
                                            bisa
                                            mengetahui rinciannya?</div>
                            ...
                            <div onclick="pageForumDiskusiPertanyaan()"
                                class="w-full h-fit flex-col justify-center items-center gap-8 flex">
                                <div class="w-full h-fit flex-col justify-start items-center gap-6 flex">
                                    <div
                                        ...
                                        <div class="h-fit justify-start items-start gap-1 flex">
                                            <div class="text-neutral-900 text-lg font-semibold font-THICCCBOI leading-7">3
                                            </div>
                                            <div class="text-neutral-900 text-lg font-semibold font-THICCCBOI leading-7">
                                                Jawaban</div>
                                        </div>
                                    ...
                                    <div class="w-full h-fit  px-6 flex-col justify-center items-center gap-4 flex">
                                            ...
                                            <div class="w-full h-fit flex-col justify-center items-start inline-flex">
                                                <div class="self-stretch justify-start items-center gap-2 inline-flex">
                                                    <div class="justify-start items-center gap-2 flex">
                                                        <div
                                                            class="text-zinc-900 text-base font-semibold font-THICCCBOI leading-normal">
                                                            Bapak Suhaili</div>
                                                ...
                                                <div class="self-stretch justify-start items-start gap-4 inline-flex">
                                                    <div
                                                        class="grow shrink basis-0 text-neutral-900 text-base font-medium font-THICCCBOI leading-normal">
                                                        9 menit lalu</div>
                                                </div>
                                            </div>
                                            <i class="text-32 ph ph-dots-three-vertical"></i>
                                        </div>
                                        <div class="w-full text-zinc-900 text-lg font-normal font-THICCCBOI leading-7">
                                            Bagaimana tahapan kipk bisa cair ke rekening tiap mahasiswa? dan apakah kita
                                            bisa
                                            mengetahui rinciannya?</div>
                                        <div class="w-full h-fit justify-start items-center gap-4 inline-flex">
                                            <div class=" rounded-full justify-start items-center gap-2 flex">
                                                ...
                                                <div
                                                    class="px-4 py-2 bg-rose-100 rounded-full justify-start items-start gap-2 flex">
                                                    <div
                                                        class="text-neutral-900 text-xs font-medium font-THICCCBOI leading-none">
                                                        30 org merasa terbantu</div>
                                                </div>
                                            </div>
                                            <div class="rounded-full justify-start items-center gap-1 flex">
                                                <i class="text-32 ph ph-chat-teardrop-text"></i>
                ...
                <section class="w-full lg:max-w-360 flex-col justify-start items-start gap-6 flex">
                    <div class="w-full py-2 px-8 bg-primary-100 rounded justify-start items-start flex">
                        <div class=" text-zinc-900 text-3xl font-extrabold font-THICCCBOI leading-10">
                            Terpopuler</div>
                    </div>
