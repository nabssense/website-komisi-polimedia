<div
    class="w-full h-fit {{ $active === 'Beranda' ? 'pt-8 lg:py-16' : '' }} px-4 md:px-8 xl:px-16 px-4 md:px-8 xl:px-16 py-20 md:py-32 bg-netral-100 flex-col justify-center items-center inline-flex">
