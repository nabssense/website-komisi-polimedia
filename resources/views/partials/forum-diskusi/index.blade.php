<div
    ...
    @auth
        <a href="/forum-diskusi/create"
            class="btn-primary {{ $active === 'Masuk Akun' || $active === 'Beranda' || $active === 'Daftar Akun' ? 'hidden' : '' }} fixed bottom-20 right-2 z-30 lg:hidden drop-shadow-2xl">
                            ...
                            <div class="flex flex-col bg-netral-100 rounded-xl w-full lg:w-480 h-fit justify-center items-center overflow-clip gap-6 p-4"
                                ...
                                <div class="w-full flex flex-col gap-4">
                                    ...
                                    <div class="w-full flex flex-col gap-2">
                                        ...
                                        <button onclick="sortDiscussions('oldest')"
                                            class="btn-popup-sm">Terlama</button>
                                        <button onclick="sortDiscussions('most_liked')" class="btn-popup-sm">Like
                                            Terbanyak</button>
                                        <button onclick="sortDiscussions('least_liked')" class="btn-popup-sm">Like
                                            Terdikit</button>
                                    </div>
                                </div>
